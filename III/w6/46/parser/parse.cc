// Generated by Bisonc++ V6.01.00 on Wed, 27 Mar 2019 14:37:14 +0100
...
PI__ const s_productionInfo[] = 
{
     ...
     {261, 1}, // 5: expr (NR) ->  NR
     {261, 1}, // 6: expr (VAR) ->  VAR
     {261, 2}, // 7: expr ('-') ->  '-' expr
     {261, 3}, // 8: expr ('+') ->  expr '+' expr
     {261, 3}, // 9: expr ('*') ->  expr '*' expr
     {261, 1}, // 10: expr ->  array
     {262, 4}, // 11: array ('[') ->  array '[' VAR ']'
     {262, 4}, // 12: array (VAR) ->  VAR '[' VAR ']'
     {262, 4}, // 13: array ('[') ->  array '[' NR ']'
     {262, 4}, // 14: array (VAR) ->  VAR '[' NR ']'
     {263, 1}, // 15: input_$ ->  input
};

// Generated by Bisonc++ V6.01.00 on Wed, 27 Mar 2019 16:46:00 +0100
...
PI__ const s_productionInfo[] = 
{
     ...
     {260, 0}, // 1: list ->  <empty>
     {260, 1}, // 2: list ->  entry
     {260, 1}, // 3: list ->  comma_list
     {260, 1}, // 4: list ->  norm_list
     {262, 3}, // 5: comma_list (',') ->  comma_list ',' entry
     {262, 3}, // 6: comma_list (',') ->  entry ',' entry
     {263, 3}, // 7: norm_list (' ') ->  norm_list ' ' entry
     {263, 3}, // 8: norm_list (' ') ->  entry ' ' entry
     {261, 1}, // 9: entry (' ') ->  ' '
     {261, 1}, // 10: entry (WORD) ->  WORD
     {261, 1}, // 11: entry (INT) ->  INT
     {261, 1}, // 12: entry (FLOAT) ->  FLOAT
     {264, 1}, // 13: list_$ ->  list
};

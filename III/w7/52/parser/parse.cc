// Generated by Bisonc++ V6.02.00 on Wed, 03 Apr 2019 17:14:33 +0200
...
PI_ const s_productionInfo[] = 
{
     ...
     {265, 1}, // 4: line (QUIT) ->  QUIT
     {265, 1}, // 5: line (LIST) ->  LIST
     {265, 1}, // 6: line ('\x0a') ->  '\x0a'
     {265, 2}, // 7: line (errTok_) ->  errTok_ '\x0a'
     {266, 1}, // 8: expr (NUMBER) ->  NUMBER
     {266, 1}, // 9: expr (IDENT) ->  IDENT
     {266, 2}, // 10: expr (uMinus) ->  '-' expr
     {266, 4}, // 11: expr (SIN) ->  SIN '(' expr ')'
     {266, 4}, // 12: expr (FNCT) ->  FNCT '(' expr ')'
...
#line 90 "grammar"
        {
         functions(d_scanner.matched(), vs_(-1));
         }
        break;

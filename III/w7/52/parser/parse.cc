// Generated by Bisonc++ V6.02.00 on Tue, 02 Apr 2019 21:21:10 +0200
...
PI_ const s_productionInfo[] = 
{
     ...
     {264, 1}, // 4: line (QUIT) ->  QUIT
     {264, 1}, // 5: line (LIST) ->  LIST
     {264, 1}, // 6: line ('\x0a') ->  '\x0a'
     {264, 2}, // 7: line (errTok_) ->  errTok_ '\x0a'
     {265, 1}, // 8: expr (NUMBER) ->  NUMBER
     {265, 1}, // 9: expr (IDENT) ->  IDENT
     {265, 4}, // 10: expr (FNCT) ->  FNCT '(' expr ')'

// Generated by Bisonc++ V6.02.00 on Tue, 02 Apr 2019 20:07:39 +0200
...
PI_ const s_productionInfo[] = 
{
     ...
     {261, 2}, // 1: lines ->  lines line
     {261, 1}, // 2: lines ->  line
     {262, 2}, // 3: line ('\x0a') ->  expr '\x0a'
     {262, 1}, // 4: line (QUIT) ->  QUIT
     {262, 1}, // 5: line ('\x0a') ->  '\x0a'
     {262, 2}, // 6: line (errTok_) ->  errTok_ '\x0a'
     {263, 1}, // 7: expr (NUMBER) ->  NUMBER
     {263, 1}, // 8: expr (IDENT) ->  IDENT
     {263, 2}, // 9: expr (uMinus) ->  '-' expr
     {263, 3}, // 10: expr ('+') ->  expr '+' expr
     {263, 3}, // 11: expr ('-') ->  expr '-' expr
     {263, 3}, // 12: expr ('(') ->  '(' expr ')'
     {263, 3}, // 13: expr ('=') ->  expr '=' expr
     {263, 3}, // 14: expr ('*') ->  expr '*' expr
     {263, 3}, // 15: expr ('/') ->  expr '/' expr
     {264, 1}, // 16: lines_$ ->  lines
};

...
class Strings
{
    ...
    public:
        ...
        Strings(Strings const &other); //copy const
        Strings(Strings &&tmp); //move const
        ...
        Strings &operator=(Strings const &other); //copy assignment operator
        Strings &operator=(Strings &&tmp); //move assignment operator
